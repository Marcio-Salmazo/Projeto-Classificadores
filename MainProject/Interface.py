...
class Interface(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(Utils.resource_path("MainProject\\figures\\figNN.png")))
        ...
        pixmap = QPixmap(Utils.resource_path("MainProject\\figures\\fig_ufu.png"))
    ...
    def run_vit_subprocess(self, config_path):
        ...
        for line in process.stdout:
            self.add_log_message(line.strip())
            self.add_log_message("---------------------------------------------------------------")
